...
CREATE TABLE `reporte` (
  ...
  `Faltas` varchar(200) NOT NULL,
  `EvidenciaPDF` text NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=10468596 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (1234567,'jijijij','',NULL,'mjfdhswfjgwe','123456','holi@holi.com','1111',2),(10468595,'Ana','ADSO',451231,'calle 12 #34','233457','ana@gmail.com','2020',1),(10468596,'Carlos','ADSO',451232,'avenida 9 #10','233458','carlos@gmail.com','1234',2),(10468598,'Jorge','ADSO',451234,'carrera 3 #6','233460','jorge@gmail.com','12',3),(10468599,'Sofia','ADSO',451235,'calle 45 #78','233461','sofia@gmail.com','123456',2),(12345678,'xxx','EDSI',1234,'Cll 52 N13 65','3103057128','jgalindos@sena.edu.co','xxxxxx',4),(21012155,'Damian','ADSO',547857,'ggjgjhghgy','12345210','dani@misena.edu.co','sasasa',4),(45664564,'David','EDSI',2558697,'Cll 52 N13 65','3132012936','daKJDK@misena.edu.co','2345788586',4),(54545454,'Andres','Sistemas',2958678,'algoX','1234789','daKJDK@misena.edu.co','789456',4),(464556465,'prueba','EDSI',2558697,'Cll 52 N13 65','3103057128','daKJDK@misena.edu.co','@misena',4);
...
-- Dump completed on 2024-09-18 12:06:12
